...
import FollowButton from "@/components/ui/customComponents/FollowButton"
...
const AuthorPage = () => {
    ...
    const { data:checkFollowing, refetch } = useIsFollowingQuery({ authorId:id, userId:currentUserId });
    ...
    <Box>
        ...
        <Box position={'relative'} px={'16px'} pb={'16px'} pt={'0'}>
            <HStack py={'5'} justifyContent={'space-between'} alignItems={'center'}>
                ...
                <FollowButton refetch={refetch} isFollowing={checkFollowing?.isFollowing} userId={currentUserId} authorId={id} size='md'/>
            </HStack>
