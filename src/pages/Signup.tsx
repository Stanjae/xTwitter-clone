...
import SignupForm from '@/components/ui/customComponents/SignupForm'
  ...
  return (
    <Box width={'320px'}>
        <Stack gap={2} direction={'column'}>
            <CustomButton fontWeight={'medium'} display={'flex'} gap={2} justifyContent={'center'} alignItems={'center'} size={'sm'} visual={'solidLight'}>
            ...
            <AuthModal btnText='Create an Account' formTitle='Create a new Account'>
                <SignupForm/>
            </AuthModal>
            ...
            <Box spaceY={'21px'} mt={{base:'40px',md:'60px'}}>
                <Text  fontSize={'17px'}  fontWeight={'medium'} lineHeight={'20px'}>Already have an Account?</Text>
                <Link style={{display:'block'}} to={'/auth/login'}>
                    <CustomButton color={'primary'} w={'full'} size={'sm'} visual={'solidBorder'}>Login</CustomButton>
                </Link>
            </Box>
        </Stack>
    </Box>
